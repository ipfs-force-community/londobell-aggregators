...
db.MinerSectorHealth.aggregate([
  ...
  var endSectors =
    item.maxData.Detail.Active +
    item.maxData.Detail.Faults +
    item.maxData.Detail.Unproven +
    item.maxData.Detail.TerminatedSectors;
  var startSectors =
    item.minData.Detail.Active +
    item.minData.Detail.Faults +
    item.minData.Detail.Unproven +
    item.minData.Detail.TerminatedSectors;
  var data = new Object();
